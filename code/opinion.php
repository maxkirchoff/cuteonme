...
<div>
	<div class="container" id="voteScreen"><!--  Show the sharer's information and message  -->
		...
		<div class="span-4 last right">
			<p><input type="image" id="yes" value="Yes" onclick="voteYes()"
				src="/static/img/thumbs-up.png" width="70" height="70" /> <input
				type="image" id="no" value="No" onclick="voteNo()"
				src="/static/img/thumbs-down.png" width="70" height="70" /></p>
		</div>
	</div>
